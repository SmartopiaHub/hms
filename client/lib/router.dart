  ...
  return GoRouter(
    ...
    redirect: (ctx, state) async {
        ...
        if (isLoggedIn && goingToSignIn) {
          ...
          final from = state.uri.queryParameters['from']; //state.pathParameters['from'];
        ...
        routes: [
            ...
            GoRoute(
              ...
              builder: (context, state) {
                ...
                return UserDetailPage(userId: id == null ? null : int.tryParse(id), user: initial);
              },
            ),
            GoRoute(
            ...
            GoRoute(
              ...
              builder: (context, state) {
                ...
                return TaskSubmissionPage(taskId: id == null ? null : int.tryParse(id), task: initial);
              },
            ),
            GoRoute(
              ...
              builder: (context, state) {
                ...
                return TaskDetailPage(taskId: id == null ? null : int.tryParse(id), task: initial);
              },
            ),
            GoRoute(
              path: '/tasks/:id/grade',
              ...
              builder: (context, state) {
                ...
                return TaskGradingPage(taskId: id == null ? null : int.tryParse(id), task: initial);
              },
            ),
            GoRoute(
              path: '/templates',
            ...
            GoRoute(
              ...
              name: 'taskCreate',
              builder: (context, state) => CreateOrEditTaskPage(),
            ),
            GoRoute(
              ...
              builder: (context, state) {
                ...
                return CreateOrEditTaskPage(taskId: id == null ? null : int.tryParse(id), taskTemplate: task);
              },
            ),
            GoRoute(
              path: '/settings',
