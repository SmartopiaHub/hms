...
class $UsersTable extends Users with TableInfo<$UsersTable, User> {
  ...
  late final GeneratedColumn<bool> allowSelfHomeworkManagement =
      GeneratedColumn<bool>(
        'allow_self_homework_management',
        aliasedName,
        false,
        type: DriftSqlType.bool,
        requiredDuringInsert: false,
  ...
  static const VerificationMeta _pointSystemIdMeta = const VerificationMeta(
    'pointSystemId',
  );
  @override
  ...
  static const VerificationMeta _redeemedPointsMeta = const VerificationMeta(
    'redeemedPoints',
  );
  @override
  ...
  User map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return User(
      ...
      pointSystemId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}point_system_id'],
      ),
      totalPoints:
          attachedDatabase.typeMapping.read(
            DriftSqlType.int,
      ...
      redeemedPoints:
          attachedDatabase.typeMapping.read(
            DriftSqlType.int,
            data['${effectivePrefix}redeemed_points'],
          )!,
    );
  }
  ...
  static JsonTypeConverter2<NotificationSetting?, String?, Object?>
  $converternotificationSettingsn = JsonTypeConverter2.asNullable(
    $converternotificationSettings,
  );
}
...
class User extends DataClass implements Insertable<User> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['allow_self_homework_management'] = Variable<bool>(
      allowSelfHomeworkManagement,
    );
    if (!nullToAbsent || notificationSettings != null) {
      map['notification_settings'] = Variable<String>(
        $UsersTable.$converternotificationSettingsn.toSql(notificationSettings),
      );
    }
  ...
  UsersCompanion toCompanion(bool nullToAbsent) {
    return UsersCompanion(
      ...
      notificationSettings:
          notificationSettings == null && nullToAbsent
              ? const Value.absent()
              : Value(notificationSettings),
      pointSystemId:
          pointSystemId == null && nullToAbsent
              ? const Value.absent()
              : Value(pointSystemId),
  ...
  factory User.fromJson(
    ...
    return User(
      ...
      allowSelfHomeworkManagement: serializer.fromJson<bool>(
        json['allowSelfHomeworkManagement'],
      ),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'allowSelfHomeworkManagement': serializer.toJson<bool>(
        allowSelfHomeworkManagement,
      ),
      'notificationSettings': serializer.toJson<Object?>(
        $UsersTable.$converternotificationSettingsn.toJson(
          notificationSettings,
        ),
      ),
  ...
  User copyWith({
    ...
    Value<NotificationSetting?> notificationSettings = const Value.absent(),
...
class UsersCompanion extends UpdateCompanion<User> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (allowSelfHomeworkManagement.present) {
      map['allow_self_homework_management'] = Variable<bool>(
        allowSelfHomeworkManagement.value,
      );
    }
    if (notificationSettings.present) {
      map['notification_settings'] = Variable<String>(
        $UsersTable.$converternotificationSettingsn.toSql(
          notificationSettings.value,
        ),
      );
    }
...
class $TaskTemplatesTable extends TaskTemplates
  ...
  assignedUsers = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: true,
  ).withConverter<List<String>>($TaskTemplatesTable.$converterassignedUsers);
  @override
  ...
  recurrence = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: true,
  ).withConverter<RecurrencePattern>($TaskTemplatesTable.$converterrecurrence);
  @override
  ...
  expectedCompletionTimeInMinutes = GeneratedColumn<int>(
    'expected_completion_time_in_minutes',
    aliasedName,
    false,
    type: DriftSqlType.int,
    requiredDuringInsert: true,
  ...
  TaskTemplate map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return TaskTemplate(
      ...
      assignedUsers: $TaskTemplatesTable.$converterassignedUsers.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}assigned_users'],
        )!,
      ),
      tags: $TaskTemplatesTable.$convertertagsn.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
      ...
      rewards: $TaskTemplatesTable.$converterrewardsn.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
      ...
      attachmentRequired:
          attachedDatabase.typeMapping.read(
            DriftSqlType.bool,
            data['${effectivePrefix}attachment_required'],
          )!,
      submissionRequired:
          attachedDatabase.typeMapping.read(
            DriftSqlType.bool,
            data['${effectivePrefix}submission_required'],
          )!,
      creationTime:
          attachedDatabase.typeMapping.read(
  ...
  static JsonTypeConverter2<NotificationSetting?, String?, Object?>
  $converternotificationSettingn = JsonTypeConverter2.asNullable(
    $converternotificationSetting,
  );
}
...
class TaskTemplate extends DataClass implements Insertable<TaskTemplate> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || tags != null) {
      map['tags'] = Variable<String>(
        $TaskTemplatesTable.$convertertagsn.toSql(tags),
      );
    }
    ...
    map['creation_time'] = Variable<DateTime>(creationTime);
    {
      map['expected_completion_time_in_minutes'] = Variable<int>(
        $TaskTemplatesTable.$converterexpectedCompletionTimeInMinutes.toSql(
          expectedCompletionTimeInMinutes,
        ),
      );
    }
    if (!nullToAbsent || notificationSetting != null) {
      map['notification_setting'] = Variable<String>(
        $TaskTemplatesTable.$converternotificationSettingn.toSql(
          notificationSetting,
        ),
      );
    }
  ...
  TaskTemplatesCompanion toCompanion(bool nullToAbsent) {
    return TaskTemplatesCompanion(
      ...
      rewards:
          rewards == null && nullToAbsent
              ? const Value.absent()
              : Value(rewards),
      penalty:
          penalty == null && nullToAbsent
              ? const Value.absent()
              : Value(penalty),
      ...
      notificationSetting:
          notificationSetting == null && nullToAbsent
              ? const Value.absent()
  ...
  factory TaskTemplate.fromJson(
    ...
    return TaskTemplate(
      ...
      assignedUsers: $TaskTemplatesTable.$converterassignedUsers.fromJson(
        serializer.fromJson<Object?>(json['assignedUsers']),
      ),
      tags: $TaskTemplatesTable.$convertertagsn.fromJson(
        serializer.fromJson<Object?>(json['tags']),
      ),
      priority: serializer.fromJson<int>(json['priority']),
      remind: serializer.fromJson<int>(json['remind']),
      description: serializer.fromJson<String?>(json['description']),
      recurrence: $TaskTemplatesTable.$converterrecurrence.fromJson(
        serializer.fromJson<Object?>(json['recurrence']),
      ),
      ...
      expectedCompletionTimeInMinutes: $TaskTemplatesTable
          ...
          .fromJson(
            serializer.fromJson<Object?>(
              json['expectedCompletionTimeInMinutes'],
            ),
          ),
      notificationSetting: $TaskTemplatesTable.$converternotificationSettingn
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'tags': serializer.toJson<Object?>(
        $TaskTemplatesTable.$convertertagsn.toJson(tags),
      ),
      ...
      'expectedCompletionTimeInMinutes': serializer.toJson<Object?>(
        $TaskTemplatesTable.$converterexpectedCompletionTimeInMinutes.toJson(
          expectedCompletionTimeInMinutes,
        ),
      ),
      'notificationSetting': serializer.toJson<Object?>(
        $TaskTemplatesTable.$converternotificationSettingn.toJson(
          notificationSetting,
        ),
      ),
    };
  ...
  TaskTemplate copyWith({
    ...
    Value<NotificationSetting?> notificationSetting = const Value.absent(),
  }) => TaskTemplate(
    id: id ?? this.id,
    ...
    expectedCompletionTimeInMinutes:
        expectedCompletionTimeInMinutes ?? this.expectedCompletionTimeInMinutes,
    notificationSetting:
        notificationSetting.present
  ...
  TaskTemplate copyWithCompanion(TaskTemplatesCompanion data) {
    return TaskTemplate(
      ...
      attachmentRequired:
          data.attachmentRequired.present
              ? data.attachmentRequired.value
              : this.attachmentRequired,
      submissionRequired:
          data.submissionRequired.present
      ...
      notificationSetting:
          data.notificationSetting.present
...
class TaskTemplatesCompanion extends UpdateCompanion<TaskTemplate> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (assignedUsers.present) {
      map['assigned_users'] = Variable<String>(
        $TaskTemplatesTable.$converterassignedUsers.toSql(assignedUsers.value),
      );
    }
    if (tags.present) {
      map['tags'] = Variable<String>(
    ...
    if (expectedCompletionTimeInMinutes.present) {
      map['expected_completion_time_in_minutes'] = Variable<int>(
        $TaskTemplatesTable.$converterexpectedCompletionTimeInMinutes.toSql(
          expectedCompletionTimeInMinutes.value,
        ),
      );
    }
...
class $TasksTable extends Tasks with TableInfo<$TasksTable, Task> {
  ...
  static const VerificationMeta _evaluationTimeMeta = const VerificationMeta(
    'evaluationTime',
  );
  @override
  ...
  static const VerificationMeta _evaluatorMeta = const VerificationMeta(
    'evaluator',
  );
  @override
  ...
  Task map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Task(
      ...
      rewards: $TasksTable.$converterrewardsn.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}rewards'],
        ),
      ...
      submittedFiles: $TasksTable.$convertersubmittedFilesn.fromSql(
        attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}submitted_files'],
        ),
      ),
      ...
      evaluationTime: attachedDatabase.typeMapping.read(
        DriftSqlType.dateTime,
        data['${effectivePrefix}evaluation_time'],
      ),
      evaluator: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}evaluator'],
      ),
      attachmentRequired:
          attachedDatabase.typeMapping.read(
            DriftSqlType.bool,
  ...
  static JsonTypeConverter2<NotificationHistory?, String?, Object?>
  $converternotificationHistoryn = JsonTypeConverter2.asNullable(
    $converternotificationHistory,
  );
  static JsonTypeConverter2<List<String>, String, Object?>
  $convertersubmittedFiles = stringListConverter;
  static JsonTypeConverter2<List<String>?, String?, Object?>
  $convertersubmittedFilesn = JsonTypeConverter2.asNullable(
    $convertersubmittedFiles,
  );
}
...
class Task extends DataClass implements Insertable<Task> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || rewards != null) {
      map['rewards'] = Variable<String>(
        $TasksTable.$converterrewardsn.toSql(rewards),
      );
    }
    if (!nullToAbsent || penalty != null) {
      map['penalty'] = Variable<String>(penalty);
    ...
    {
      map['expected_completion_time_in_minutes'] = Variable<int>(
        $TasksTable.$converterexpectedCompletionTimeInMinutes.toSql(
          expectedCompletionTimeInMinutes,
        ),
      );
    }
    if (!nullToAbsent || notificationSetting != null) {
      map['notification_setting'] = Variable<String>(
        $TasksTable.$converternotificationSettingn.toSql(notificationSetting),
      );
    }
    if (!nullToAbsent || notificationHistory != null) {
      map['notification_history'] = Variable<String>(
        $TasksTable.$converternotificationHistoryn.toSql(notificationHistory),
      );
    }
    ...
    return TasksCompanion(
      ...
      notificationSetting:
          notificationSetting == null && nullToAbsent
              ...
              : Value(notificationSetting),
      notificationHistory:
          notificationHistory == null && nullToAbsent
              ? const Value.absent()
              : Value(notificationHistory),
      submittedFiles:
          submittedFiles == null && nullToAbsent
              ? const Value.absent()
      ...
      evaluationTime:
          evaluationTime == null && nullToAbsent
              ? const Value.absent()
              : Value(evaluationTime),
      evaluator:
          evaluator == null && nullToAbsent
              ? const Value.absent()
              : Value(evaluator),
      attachmentRequired: Value(attachmentRequired),
      submissionRequired: Value(submissionRequired),
  ...
  factory Task.fromJson(
    ...
    return Task(
      ...
      title: serializer.fromJson<String>(json['title']),
      description: serializer.fromJson<String?>(json['description']),
      tags: $TasksTable.$convertertagsn.fromJson(
        serializer.fromJson<Object?>(json['tags']),
      ),
      remind: serializer.fromJson<int>(json['remind']),
      assignedUsers: $TasksTable.$converterassignedUsers.fromJson(
        serializer.fromJson<Object?>(json['assignedUsers']),
      ),
      rewards: serializer.fromJson<RewardInfo?>(json['rewards']),
      penalty: serializer.fromJson<String?>(json['penalty']),
      ...
      notificationSetting: $TasksTable.$converternotificationSettingn.fromJson(
        serializer.fromJson<Object?>(json['notificationSetting']),
      ),
      notificationHistory: $TasksTable.$converternotificationHistoryn.fromJson(
        serializer.fromJson<Object?>(json['notificationHistory']),
      ),
      submittedFiles: $TasksTable.$convertersubmittedFilesn.fromJson(
        serializer.fromJson<Object?>(json['submittedFiles']),
      ),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'description': serializer.toJson<String?>(description),
      'tags': serializer.toJson<Object?>(
        $TasksTable.$convertertagsn.toJson(tags),
      ),
      'remind': serializer.toJson<int>(remind),
      'assignedUsers': serializer.toJson<Object?>(
      ...
      'expectedCompletionTimeInMinutes': serializer.toJson<Object?>(
        $TasksTable.$converterexpectedCompletionTimeInMinutes.toJson(
          expectedCompletionTimeInMinutes,
        ),
      ),
      'notificationSetting': serializer.toJson<Object?>(
        $TasksTable.$converternotificationSettingn.toJson(notificationSetting),
      ),
      'notificationHistory': serializer.toJson<Object?>(
        $TasksTable.$converternotificationHistoryn.toJson(notificationHistory),
      ),
  ...
  Task copyWith({
    ...
    Duration? expectedCompletionTimeInMinutes,
    Value<NotificationSetting?> notificationSetting = const Value.absent(),
    Value<NotificationHistory?> notificationHistory = const Value.absent(),
    ...
    return Task(
      ...
      notificationSetting:
          data.notificationSetting.present
              ...
              : this.notificationSetting,
      notificationHistory:
          data.notificationHistory.present
              ? data.notificationHistory.value
              : this.notificationHistory,
      submittedFiles:
          data.submittedFiles.present
...
class TasksCompanion extends UpdateCompanion<Task> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (rewards.present) {
      map['rewards'] = Variable<String>(
        $TasksTable.$converterrewardsn.toSql(rewards.value),
      );
    }
    if (penalty.present) {
      map['penalty'] = Variable<String>(penalty.value);
    ...
    if (notificationSetting.present) {
      map['notification_setting'] = Variable<String>(
        $TasksTable.$converternotificationSettingn.toSql(
          notificationSetting.value,
        ),
      );
    }
    if (notificationHistory.present) {
      map['notification_history'] = Variable<String>(
        $TasksTable.$converternotificationHistoryn.toSql(
          notificationHistory.value,
        ),
      );
    }
...
class $RedemptionsTable extends Redemptions
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<Redemption> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
...
class Redemption extends DataClass implements Insertable<Redemption> {
  ...
  RedemptionsCompanion toCompanion(bool nullToAbsent) {
    return RedemptionsCompanion(
      ...
      itemImageUrl:
          itemImageUrl == null && nullToAbsent
              ? const Value.absent()
              : Value(itemImageUrl),
      cost: Value(cost),
  ...
  Redemption copyWith({
    ...
    itemImageUrl: itemImageUrl.present ? itemImageUrl.value : this.itemImageUrl,
    cost: cost ?? this.cost,
...
typedef $$ShopItemsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$RedemptionsTableCreateCompanionBuilder =
    RedemptionsCompanion Function({
      Value<int> id,
      required int userId,
      required String itemTitle,
      Value<String?> itemImageUrl,
...
typedef $$RedemptionsTableUpdateCompanionBuilder =
    RedemptionsCompanion Function({
      Value<int> id,
      Value<int> userId,
      Value<String> itemTitle,
...
class $$RedemptionsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $RedemptionsTable,
          ...
          (
            Redemption,
            BaseReferences<_$AppDatabase, $RedemptionsTable, Redemption>,
          ),
          Redemption,
          PrefetchHooks Function()
        > {
...
typedef $$RedemptionsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $RedemptionsTable,
      Redemption,
